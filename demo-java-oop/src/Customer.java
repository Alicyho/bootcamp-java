...
public class Customer {
  ...
  public Customer() {// 這個可以不用打出來，SYSTEM已經有, 因為這個NEW CONSTRUCTOR，
    //已存在，所以 "Creating Customer" 會被路來
    System.out.println("Creating Customer...");
    // ! advanced
    this.orders = new Order[0];// 在這概念上O是一個長度，但其實沒有長度，一CALL就爆，定性為物件
  }
 ...
 public void addOrder(Order newOrder) {
    ...
    this.orders = newOrders;//(將子針指向這個程式)
  }
