...
public class DataStructureExercise1 {
  public static void main(String[] args) {
   ...
   boolean removedItem =  numbers.remove(Integer.valueOf(30));
...
ArrayList<String> fruits = new ArrayList <String>();
    ...
    HashSet<Integer> newsetnoduplicate = new HashSet<Integer>(numbers1);
    System.out.println(newsetnoduplicate);
